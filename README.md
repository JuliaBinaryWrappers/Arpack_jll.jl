# `Arpack_jll.jl` (v3.9.1+3)

[![deps](https://juliahub.com/docs/Arpack_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Arpack_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/1b6ab3d9200d0095fef9dbcc4eb2efe8d1e73ecc/A/Arpack/Arpack/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
